...
socio_professionel_ga.update_layout(
    ...
    plot_bgcolor='#ffffff',
    title={
        'text': "<b> Individus déclarant des symptômes anxieux par situation professionnelle <b>",
        'y':0.95,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'
...
covid_symptomes_ga.update_layout(
    ...
    plot_bgcolor='#ffffff',
    title={
        'text': "<b> Individus présentant un risque de développer une forme grave de COVID-19 déclarant des symptômes anxieux <b>",
        'y':0.95,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'
...
covid_risque_ga.update_layout(
    ...
    plot_bgcolor='#ffffff',
    title={
        'text': "<b> Individus ayant ou ayant eu des symptômes COVID et déclarant des symptômes d'anxiété <b>",
        'y':0.95,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'
